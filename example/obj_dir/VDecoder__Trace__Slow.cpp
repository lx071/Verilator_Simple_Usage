...
void VDecoder::traceInitThis__1(VDecoder__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->declBit(c+1,"reset", false,-1);
        vcdp->declBus(c+9,"S", false,-1, 2,0);
        vcdp->declBus(c+17,"out", false,-1, 7,0);
        vcdp->declBit(c+1,"Decoder reset", false,-1);
        vcdp->declBus(c+9,"Decoder S", false,-1, 2,0);
        vcdp->declBus(c+17,"Decoder out", false,-1, 7,0);
    }
}
...
void VDecoder::traceFullThis__1(VDecoder__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+9,(vlTOPp->S),3);
        vcdp->fullBus(c+17,(vlTOPp->out),8);
    }
}
